...
const PRODUCTS = [
  ...
  { key: 'mark8ly', title: 'Mark8ly', subtitle: 'Marketplace SaaS · multi-tenant', icon: Store, route: '/mark8ly', live: true },
  { key: 'devai', title: 'DevAI', subtitle: 'Developer AI platform', icon: Bot, route: '/devai', live: true },
] as const;

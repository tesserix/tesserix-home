...
const HEADER = [
  ...
  "tds", "penalty_deductions", "bonus_additions", "recovery_deductions",
  "net_payout", "currency",
  "status", "paid_at", "payout_ref",
];
  ...
  try {
    ...
    for (const s of rows) {
      lines.push([
        ...
        s.penalty_deductions.toFixed(2), s.bonus_additions.toFixed(2),
        s.recovery_deductions.toFixed(2),
        s.net_payout.toFixed(2), s.currency, s.status,
